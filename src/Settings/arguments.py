...
def prepare_parser():
    ...
    parser.add_argument("--data_directory", type=str,
                        default="/Users/alessandrozonta/PycharmProjects/deapGeneration/Data/",
                        help="Directory with the data")
    parser.add_argument("--config_path", type=str,
                        default="/Users/alessandrozonta/PycharmProjects/NEAT/src/Settings/config-neat",
                        help="Directory with the settings "
                             "for NEAT")
